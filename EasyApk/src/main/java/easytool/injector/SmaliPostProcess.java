...
public class SmaliPostProcess {
    private final String toolPackage = "easytool/injector/packages/";
    private final String toolClassName = "easytool/injector/code/AppodealCode";
    private File defaultSmaliFile;
    private File modifiedSmaliFile;
    private String userMainClassName;
    private ArrayList<String> activityRequireMethods;
