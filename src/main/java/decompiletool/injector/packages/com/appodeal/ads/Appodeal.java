...
import decompiletool.injector.packages.android.app.Activity;
import decompiletool.injector.packages.android.content.Context;
...
public class Appodeal {
  ...
  public static boolean show(Activity activity, int adTypes) {
    return true;
  }

  public static boolean show(Activity activity, int adTypes, String placementName) {
    return true;
  }
  ...
  public static boolean canShow(int adTypes) {
    return true;
  }

  public static boolean canShow(int adTypes, String placementName) {
    return true;
  }
  ...
  public static double getPredictedEcpm(final int adType) {
    return 0.0f;
  }
}